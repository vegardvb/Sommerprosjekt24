import {
  ...
  export class CesiumDirective implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
      ...
      viewer.screenSpaceEventHandler.setInputAction((movement: { position: Cartesian2; }) => {
        ...
        if (defined(pickedObject)) {
          ...
          viewer.selectedEntity = entity;  // Set the selected entity
    ...
    private extractBbox(): void {
      ...
      if (clippingPlanes) {
        ...
        console.log('bbox', this.bboxExtracted)
  ...
  public updateEntityPosition(cartesian: Cartesian3) {
    ...
    public setTilesetVisibility(visible: boolean) {
      if (this.tileset) {
        this.tileset.show = visible;
      }
    }
  
    public setPolygonsVisibility(visible: boolean) {
