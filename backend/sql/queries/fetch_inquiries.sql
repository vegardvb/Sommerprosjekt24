...
/*
    Fetches information about inquiries and their related attributes from the database.
    ...
    - mail: The email address of the customer associated with the inquiry
    - municipality: The name of the municipality associated with the inquiry
    ...
    - number_of_measurements: The number of cable measurements related to the inquiry
*/
