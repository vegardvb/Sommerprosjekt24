...
def execute_sql(connection, main_file_path, placeholders=None, params=None):
    ...
    Args:
        ...
        placeholders (dict, optional): Dictionary containing the placeholder and path. 
            Defaults to None.
        params (dict, optional): Dictionary containing the parameters and their name 
            to be injected into the query file. Defaults to None.
...
def execute_sql_put(connection, main_file_path, placeholders=None, params=None):
    """Executes SQL from a file with specified parameters and placeholders.
